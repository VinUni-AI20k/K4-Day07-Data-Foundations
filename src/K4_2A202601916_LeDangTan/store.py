...
class EmbeddingStore:
    ...
    def _make_record(self, doc: Document) -> dict[str, Any]:
        ...
        # Plain Documents used outside the ingestion pipeline still need to be
        # deletable by their document id.
    ...
    def add_documents(self, docs: list[Document]) -> None:
        ...
        for doc in docs:
            if not isinstance(doc, Document):
                raise TypeError("add_documents expects Document instances")
