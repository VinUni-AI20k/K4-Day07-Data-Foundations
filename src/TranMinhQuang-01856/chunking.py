...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Keep the punctuation by splitting on the whitespace *after* a
        # sentence-ending mark.  Newlines after a sentence are boundaries too.
        sentences = [
            sentence.strip()
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # Once no natural boundary remains, guarantee progress by cutting at
        # the requested character limit.  The empty separator means the same
        # thing and must be handled explicitly because str.split("") is invalid.
        ...
        # Reattach each delimiter to the preceding part.  This is especially
        # important for ". ": dropping it would remove sentence punctuation.
        parts = [
...
class ChunkingStrategyComparator:
    ...
    def compare(self, text: str, chunk_size: int = 200) -> dict:
        ...
        strategies = {
            # No overlap keeps this baseline valid even for very small target
            # sizes and avoids counting duplicated characters in its statistics.
